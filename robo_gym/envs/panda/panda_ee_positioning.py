...
class EndEffectorPositioningPanda(PandaBaseEnv):
    ...
    def reset(self, joint_positions=JOINT_POSITIONS, ee_target_pose=None, randomize_start=False,
...
class EndEffectorPositioningPandaSim(EndEffectorPositioningPanda, Simulation):
    ...
    def __init__(self, ip=None, lower_bound_port=None, upper_bound_port=None, gui=False, panda_model='panda', **kwargs):
        ...
        EndEffectorPositioningPanda.__init__(self, rs_address=self.robot_server_ip, panda_model=panda_model, **kwargs)
